...
export default function CustomerListBanner({ totalCustomers, filteredCount }) {
  return (
    <FadeIn>
      <div className="relative overflow-hidden bg-primary/15 rounded-[2.5rem] border border-base-300 shadow-xl mb-10 group">
        ...
        {/* Animated Glow Orbs */}
        <div className="absolute top-[-40px] right-[-40px] w-64 h-64 bg-primary/20 rounded-full blur-[80px] animate-pulse"></div>
        <div className="absolute bottom-[-30px] left-[-20px] w-48 h-48 bg-secondary/20 rounded-full blur-[60px]"></div>
        ...
        <div className="relative px-8 py-10 flex flex-col lg:flex-row items-center justify-between gap-8">
          ...
          <div className="flex flex-col md:flex-row items-center gap-6 text-center md:text-left">
            ...
            <div className="space-y-1">
              <RevealText className="text-3xl md:text-5xl font-black text-base-content tracking-tighter">
                গ্রাহকের{" "}
          ...
          <FadeIn>
            <div className="flex items-center gap-8 bg-base-100/40 backdrop-blur-2xl border border-white/20 p-6 rounded-[2.5rem] shadow-2xl group-hover:translate-y-[-5px] transition-transform duration-500">
              ...
              <div className="h-10 w-[2px] bg-primary/20 rounded-full"></div>
